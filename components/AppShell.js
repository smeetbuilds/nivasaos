...
function Brand({ compact = false }) { return <Link href="/dashboard" className={`brand${compact ? " brand-compact" : ""}`}><span className="brand-mark"><Icon name="building" size={compact ? 19 : 22}/></span><span><strong>NivasaOS</strong><small>Modular property OS</small></span></Link>; }
