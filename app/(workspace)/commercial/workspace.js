...
export default async function CommercialPage({ searchParams }) {
  ...
  const emptyText = properties.length
    ? "Create a lease under a commercial property, then add its business profile here."
