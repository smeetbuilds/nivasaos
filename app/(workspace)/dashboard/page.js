...
export default async function DashboardPage({ searchParams }) {
  ...
  return <>
    ...
    <PageHeader eyebrow="Portfolio control" title="Good to see you." description="A unified view of collections and risk, with module-specific health for residential, shared accommodation, and commercial operations." actions={<Link href="/invoices" className="button primary"><Icon name="plus" size={17}/>Create invoice</Link>}/>
