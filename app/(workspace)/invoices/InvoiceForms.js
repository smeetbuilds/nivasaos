...
export default function InvoiceForms({ workspace, lateFeeDetail }) {
  ...
  return <>
    ...
    <form action={createRentRunAction}><ModalForm id="rent-run-modal" title="Run monthly rent billing" description="NivasaOS creates only missing invoices inside your billing permission scope." submitLabel="Generate rent invoices" pendingLabel="Generating…"><div className="modal-body">
    ...
    <form action={createLateFeeRunAction}><ModalForm id="late-fee-run-modal" title="Apply eligible late fees" description="Rules are read from each permitted property’s billing policy and recalculated when you submit." submitLabel="Generate late fees" pendingLabel="Generating…"><div className="modal-body">
