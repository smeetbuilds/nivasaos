...
export default async function TenantsPage({ searchParams }) {
  ...
  return <>
    ...
    <PageHeader eyebrow="Residents" title="Tenants" description="Maintain resident profiles, occupancy details, and secure self-service portal access inside your people-management scope." actions={<><Link href="/tenant-portal" className="button secondary"><Icon name="portal" size={17}/>Tenant portal</Link><OpenModalButton target="tenant-modal" icon="plus">Add tenant</OpenModalButton></>}/>
