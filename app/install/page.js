...
export const metadata = { title: "Install modular workspace", robots: { index: false, follow: false }, referrer: "no-referrer" };
...
export default function InstallPage() {
  ...
  return <main className="modular-install-page">
    <aside className="modular-install-story" aria-labelledby="installation-story-title">
      <div className="auth-brand"><BrandLogo branding={DEFAULT_BRANDING} variant="dark"/></div>
      <div className="modular-story-copy"><span className="pill">One platform · Multiple operating models</span><h1 id="installation-story-title">Build the property operating system your portfolio actually needs.</h1><p>Choose residential, PG, hostel, student, staff, or commercial workflows. Every property stays module-specific while finance, security, audit, and reporting remain unified.</p></div>
      <div className="modular-story-points" aria-label="Installation capabilities">
    ...
    <section className="modular-install-panel" aria-label="Workspace installation wizard"><InstallWizard installationProtection={protection}/></section>
  </main>;
}
