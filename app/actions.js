...
export async function logoutAction(formData) {
  return auth.logoutAction(formData);
}
...
export async function createLeaseAction(formData) {
  return leases.createLeaseAction(formData);
}

export async function endLeaseAction(formData) {
  return leases.endLeaseAction(formData);
}
...
export async function createMaintenanceAction(formData) {
  return maintenance.createMaintenanceAction(formData);
}

export async function updateMaintenanceAction(formData) {
  return maintenance.updateMaintenanceAction(formData);
}
...
export async function toggleUserAction(formData) {
  return team.toggleUserAction(formData);
}

export async function updateSettingsAction(formData) {
  return settings.updateSettingsAction(formData);
}
