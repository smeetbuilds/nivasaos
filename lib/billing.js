...
export function eligibleLateFeeInvoices(user, propertyId = null, businessToday = today()) {
...
export function lateFeeSummary(user, propertyId = null, businessToday = today()) {
  const rows = eligibleLateFeeInvoices(user, propertyId, businessToday);
