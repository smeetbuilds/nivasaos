...
import { applySecurityMigrations } from "@/lib/schema/security-migrations";
import { applyReleaseMigrations } from "@/lib/schema/release-migrations";
import { applyMoneyMigrations } from "@/lib/schema/money-migrations";
import { applyLocalizationMigrations } from "@/lib/schema/localization-migrations";
