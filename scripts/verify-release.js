...
const requiredFiles = [
  ".env.production.example", ".circleci/config.yml", ".github/ISSUE_TEMPLATE/bug_report.yml",
  ".github/ISSUE_TEMPLATE/feature_request.yml", ".github/ISSUE_TEMPLATE/config.yml", "Caddyfile",
  "compose.yml", "compose.production.yml", "docs/BACKUPS.md", "docs/KNOWN_LIMITATIONS.md",
  "docs/PRODUCTION_RELEASE.md", "lib/runtime-config.js", "lib/schema/security-migrations.js",
  "scripts/create-install-token.js", "scripts/start.js", "scripts/backup.js", "scripts/restore.js",
  "scripts/lib/operations.js", "scripts/lib/tar-archive.js", "scripts/verify-secrets.js",
  "scripts/verify-auth-hardening.js", "scripts/verify-authorization.js", "scripts/verify-compose.js",
  "scripts/verify-integration.js", "scripts/container-gate.js", "app/(workspace)/operations/page.js",
  "app/(workspace)/reservations/page.js", "app/(workspace)/housekeeping/page.js",
  "app/portal/(account)/requests/page.js", "app/styles/part-12.css", "lib/actions/verticals.js",
  "lib/actions/property-module-update.js", "lib/permissions.js", "lib/schema/release-migrations.js",
  "scripts/verify-verticals.js", "bun.lock"
];
...
const contracts = {
  ...
  ".circleci/config.yml": ["oven/bun:1.3.0", "release-gate", "bun install --frozen-lockfile", "bun run gate"],
...
console.log("NivasaOS 1.1 packaging, authorization, authentication, integration, backup recovery, container contracts, CI evidence, and release documentation are intact.");
